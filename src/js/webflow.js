...
window.tram = function(t) {
  ...
  var j = i.frame = function() {
    ...
    T = h(function(i) {
      function n(t, i) {
        ...
        i = i || {};
        var r = L[n];
        if (!r) return K("Unsupported property: " + n);
      ...
      function r(t, i, e) {
        if (t) {
          var r = typeof t;
          if (i || (this.timer && this.timer.destroy(), this.queue = [], this.active = !1), "number" == r && i) return this.timer = new P({
            duration: t,
            context: this,
            complete: o
      ...
      function a(t) {
        return this.active ? (this.queue.push({
          options: t,
          args: arguments
        }), this.timer.complete = o, void 0) : K("No active transition timer. Use start() or wait() before then().")
      }
      ...
      function h(t, i) {
        ...
        var e;
        "string" == typeof t ? (e = {}, e[t] = 1) : e = "object" == typeof t && null != t ? t : this.props, i ? (m.call(this, e, y), b.call(this), m.call(this, e, w)) : (m.call(this, e, g), b.call(this))
      }

      function l(t) {
        h.call(this, t), m.call(this, t, k, x)
      }
      ...
      function z(t, e) {
        i[t] = function() {
          return this.children ? $.call(this, e, arguments) : (this.el && e.apply(this, arguments), this)
        }
      }
      ...
      }, z("add", n), z("start", r), z("wait", s), z("then", a), z("next", o), z("stop", h), z("set", l), z("show", f), z("hide", d), z("redraw", p)
    }),
    U = h(T, function(i) {
      function e(i, e) {
        var n = t.data(i, b) || t.data(i, b, new T.Bare);
    ...
    I = h(function(t) {
      ...
      t.init = function(t, e, r, s) {
        ...
        var a = e[0];
        r[2] && (a = r[2]), D[a] && (a = D[a]), this.name = a, this.type = r[1], this.duration = u(e[1], this.duration, n.duration), this.ease = i(e[2], this.ease, n.ease), this.delay = u(e[3], this.delay, n.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.unit = s.unit || this.unit || Y.defaultUnit, this.angle = s.angle || this.angle || Y.defaultAngle, Y.fallback || s.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + q + this.duration + "ms" + ("ease" != this.ease ? q + l[this.ease][0] : "") + (this.delay ? q + this.delay + "ms" : ""))
      }, t.set = function(t) {
        ...
        var i = this.nextStyle;
        (this.active || i) && (this.active = !1, this.nextStyle = null, this.update(t ? i : this.get()));
        var e = this.tween;
        e && e.active && (t && e.render(e.start + e.delay + e.duration), e.destroy())
    ...
    O = h(function(i) {
      ...
      function a() {
        ...
        if (n)
          for (j(a), i = G(), t = n; t--;) e = d[t], e && e.render(i)
      }
      ...
      i.init = function(t) {
        ...
        var e = t.from,
          n = t.to;
        void 0 === e && (e = f.from), void 0 === n && (n = f.to), this.unit = t.unit || "", "number" == typeof e && "number" == typeof n ? (this.begin = e, this.change = n - e) : this.format(n, e), this.value = this.begin + this.unit, this.start = G(), t.autoplay !== !1 && this.play()
      }, i.play = function() {
  ...
  var E = t.style,
    ...
    L = {
      ...
      "border-width": [I, w],
      "border-top-width": [I, w],
      "border-right-width": [I, w],
      "border-bottom-width": [I, w],
      "border-left-width": [I, w],
      "border-spacing": [I, w],
      "letter-spacing": [I, w],
      margin: [I, w],
      "margin-top": [I, w],
